...
\begin{scope}[shift={(1.5, 0.45)}]
  ...
  % Improvement arrows
  \draw[-{Stealth[scale=0.5]}, very thick, drawRedLine] (2.1, 2.0) -- (2.1, 1.7);
  \node[font=\scriptsize\bfseries, text=drawRedLine, fill=white, inner sep=1pt]
      at (2.1, 2.35) {$\downarrow$18.3\%};
  \draw[-{Stealth[scale=0.5]}, very thick, drawRedLine] (4.1, 2.3) -- (4.1, 1.85);
  \node[font=\scriptsize\bfseries, text=drawRedLine, fill=white, inner sep=1pt]
      at (4.1, 2.65) {$\downarrow$21.7\%};
\end{scope}
