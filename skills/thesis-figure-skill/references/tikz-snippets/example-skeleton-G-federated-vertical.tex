...
% Fix G.4: was anchor=north west at y=3.5 — INSIDE panel top y=3.6 by 0.1cm.
% Move to anchor=south west at y=3.7 so title sits clearly ABOVE the panel.
\node[font=\small\bfseries, text=drawBlueLine!80!black, anchor=south west]
    at (-0.8, 3.7) {实验结果：三城市联合预测性能};
...
\node[font=\footnotesize\bfseries, text=drawBlueLine!80!black,
      ...
      inner sep=5pt, anchor=south west] at (9.0, 3.7)
    {数据不出域，隐私安全};
