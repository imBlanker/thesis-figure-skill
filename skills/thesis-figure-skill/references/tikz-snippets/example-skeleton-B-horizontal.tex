...
%
% Sub-agent customization: change titles + labels + colors. Keep grid.
% =====================================================================
...
\def\xH{1.0}\def\yH{6.1}\def\cs{0.4}\def\N{5}
\foreach \i in {1,...,\N} {
  \foreach \j in {1,...,\N} {
...
\node[font=\tiny, color=acaGreyLine, anchor=south]
  at (\xBC + 1.3, \yBC - 0.45) {Method Comparison};
...
\node[base box, fill=white, draw=acaGreenLine, text=acaGreenLine!30!black,
      minimum width=3.5cm] (s5_out) at (22.25, 6.8) {Output};

% Metric card
\node[draw=acaGreenLine, fill=white, rounded corners=4pt,
      line width=0.6pt, minimum width=3.0cm, minimum height=1.5cm,
      align=center, inner sep=4pt] at (22.25, 5.2)
  {{\Large\bfseries\color{acaGreenLine} 92.4\%}\\[2pt]
   {\tiny\color{acaGreyLine} Top-1 Acc.}};
