...
\definecolor{barGreen}{HTML}{22C55E}
\definecolor{barOrange}{HTML}{F59E0B}
\definecolor{barRed}{HTML}{EF4444}
\definecolor{heatDeep}{HTML}{6D28D9}
\definecolor{heatDark}{HTML}{3B82F6}
\definecolor{heatMid}{HTML}{93C5FD}
\definecolor{heatLight}{HTML}{DBEAFE}
\definecolor{heatBg}{HTML}{F0F4FF}
...
\begin{scope}[shift={(15.2, 6.8)}]
  ...
  \node[font=\tiny, text=drawGreyLine] at (1.4, -0.5) {\scriptsize 准确率(\%)};
\end{scope}
...
\begin{scope}[shift={(20.5, 12.6)}]
  ...
  \node[font=\tiny, text=drawBlueLine] at (0.8, 0.5) {CT注意力区域};
\end{scope}
...
\node[font=\small\bfseries, text=drawBlueLine!80!black, anchor=north west]
    at (1.5, 3.0) {多模态融合性能对比 (AUC)};
...
\draw[feed_arrow, rounded corners=8pt, line width=1.2pt]
    (mdt.south) -- ++(0, -1.0) -- (-1.5, 4.0) -- (-1.5, 10) -- (ct.west |- 0,10) -- (path.west);
\node[font=\footnotesize\bfseries, text=drawRedLine,
      fill=white, fill opacity=0.9, text opacity=1,
      inner sep=3pt, rounded corners=2pt] at (12, 3.8) {MDT 反馈优化};
