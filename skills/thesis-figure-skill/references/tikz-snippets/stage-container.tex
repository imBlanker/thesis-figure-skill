...
\node[font=\scriptsize, anchor=center, color=acaTealLine]
  at (s1.center) {\textit{(heatmap / graph / formula\\here)}};
...
\node[font=\scriptsize, anchor=center, color=acaPurpleLine]
  at (s2.center) {\textit{(heatmap / graph / formula\\here)}};
...
\node[font=\scriptsize, anchor=center, color=acaOrangeLine]
  at (s3.center) {\textit{(heatmap / graph / formula\\here)}};
