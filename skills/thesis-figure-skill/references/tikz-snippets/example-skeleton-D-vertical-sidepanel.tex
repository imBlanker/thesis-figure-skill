...
% =====================================================================
% Switch styles by REPLACING the entire "PRESET DEFINITION" block below
% (between BEGIN/END markers). Aliases remain unchanged so body code is
% never touched.
%
% Available presets (see references/style-presets/):
%   - academic   (this file — soft pastels, drop shadows, sans rounded)
%   - brutalism  (B&W + single accent, thick borders, no shadows)
%   - editorial  (single accent + grey, generous whitespace)
%   - luxury     (pastels + hairlines, refined typography)
%
% Token semantics (16 tokens):
%   c_primary_*       main entity layer (clients/inputs/parties)
%   c_hero_*          core processing zone — hero color
%   c_hero_{deep,mid,light,pale}  hero internal depth layers
%   c_accent_*        secondary/specialty zone (e.g., security)
%   c_success_*       positive indicators (checks, OK)
%   c_data_curve_*    chart curves / time-series plots
%   c_warning_*       alerts / red
%   c_neutral_*       grey strokes / fills / axes
%   c_bar_{1,2,3}     multi-bar chart palette
% =====================================================================
...
% Body code references the old names; these alias to the tokens above.
% When switching presets, only the PRESET DEFINITION block changes.
...
\colorlet{purpleDeep}{c_hero_deep}               \colorlet{purpleMid}{c_hero_mid}
\colorlet{purpleLight}{c_hero_light}             \colorlet{purplePale}{c_hero_pale}
...
\colorlet{chartBlue}{c_bar_1}                    \colorlet{chartGreen}{c_bar_2}
\colorlet{chartOrange}{c_bar_3}
