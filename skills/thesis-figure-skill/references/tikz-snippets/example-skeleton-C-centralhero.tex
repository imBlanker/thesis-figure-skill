...
% Fix: was yH=4.7 → heatmap bottom y=1.5 (= hero zone bottom!), heatmap
% pixels touching zone border. yH=5.0 → bottom y=1.8 (0.3cm padding).
\def\xH{8.5}\def\yH{5.0}\def\cs{0.4}\def\N{8}
\foreach \i in {1,...,\N} {
  \foreach \j in {1,...,\N} {
